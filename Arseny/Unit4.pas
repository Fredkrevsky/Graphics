...
if ii >= 900 then
  begin
    ...
    try
      ...
      BmpLocal.Canvas.Ellipse(15, 40, 85, 110);   //Круг колонки слева (верх)
      BmpLocal.Canvas.Ellipse(15, 190, 85, 260);   //Круг колонки слева (низ)
...
begin
 ...
 { i := -5;
  while i <= 1940  do
    ...
    Bmp.Canvas.Ellipse(150, 270, 200, 600);   //Левая Колонка
    ...
    Bmp.Canvas.Ellipse(90, 310, 160, 380);   //Круг колонки слева (верх)
    Bmp.Canvas.Ellipse(90, 460, 160, 530);   //Круг колонки слева (низ)
    Bmp.Canvas.Pen.Color := clBlack;
    Bmp.Canvas.Brush.Color := clGray;
    ...
    if ii <= 872 then
      ...
      begin
        ...
        Bmp.Canvas.Ellipse(1980, -200, 1810, 300);     //Правая шторка
      end;
    Bmp.Canvas.Pen.Color := clBlack;
    Bmp.Canvas.Brush.Color := $00020062;
